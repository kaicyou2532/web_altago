...
const useCases = [
  {
    icon: ShoppingBag,
    title: '調達代行',
    description: '現地限定品・海外ブランドの商品を、その国にいるランナーに購入・発送してもらえます。',
    example: '例：パリのブランドショップで限定バッグを購入',
  },
  {
    icon: FileText,
    title: '手続き代行',
    description: '役所・大使館・現地機関での書類取得など、物理的な手続きを代わりに行ってもらえます。',
    example: '例：現地の公証役場で書類を取得',
  },
  {
    icon: Gift,
    title: 'サプライズ配送',
    description: '海外にいる大切な人へ、現地のランナーを通じてプレゼントや花を届けることができます。',
    example: '例：ロンドンの友人の誕生日に花束を届ける',
  },
];
